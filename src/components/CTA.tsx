        ...
        <div className="max-w-5xl mx-auto glass-card rounded-2xl p-8 md:p-12 shadow-lg shadow-cosmic-accent/10 animate-fade-in relative overflow-hidden">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center relative z-10">
            ...
            <div>
              ...
              <Button
                size="lg"
                className="text-lg px-8 py-6 glow bg-gradient-to-r from-cosmic-purple to-cosmic-accent border-0 hover:from-cosmic-accent hover:to-cosmic-purple transition-all duration-300 group"
              >
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-4">
                <div
                  className="glass-card rounded-lg p-4 h-24 flex items-center justify-center text-center animate-fade-in transform hover:scale-105 transition-transform"
                  style={{ animationDelay: "100ms" }}
                >
                  <div>
                    <div className="text-cosmic-highlight font-medium text-3xl">10k+</div>
                ...
                >
                  <div>
                    <div className="text-cosmic-cyan font-medium text-3xl">200+</div>
              ...
              <div className="space-y-4 mt-8">
                ...
                >
                  <div>
                    <div className="text-cosmic-accent font-medium text-3xl">5k+</div>
                ...
                >
                  <div>
                    <div className="text-blue-400 font-medium text-3xl">Daily</div>
